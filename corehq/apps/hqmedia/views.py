...
def update_multimedia_paths(request, domain, app_id):
    ...
    with get_spreadsheet(f) as spreadsheet:
        ...
        for module in app.modules:
            for lang in app.langs:
                if module.icon_by_language(lang) in paths:
                    # TODO: slow? calls get_app and probably remove_unused_mappings
                ...
                # TODO: custom_icon_form_and_text_by_language
        ...
        for old_path, new_path in six.iteritems(paths):
            # TODO: this will break down if doing renames to old paths
